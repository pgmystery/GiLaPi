    ...
    <SvgIcon sx={ {
      ...
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="93.97 97.52 192.07 185">
        <g id="LOGO">
          ...
          <path fill="#fca326"
                d="m153.43 256.89 19.7 14.91 12 9.06a8.07 8.07 0 0 0 9.76 0l12-9.06 19.7-14.91S209.55 244 190 229.25c-19.55 14.75-36.57 27.64-36.57 27.64ZM132.58 185.84A88.19 88.19 0 0 0 97.44 170l-.26.69a48.54 48.54 0 0 0 16.1 56.1l.09.07.24.17 39.82 29.82L190 229.21Z"/>
        </g>
      </svg>
    </SvgIcon>
  )
